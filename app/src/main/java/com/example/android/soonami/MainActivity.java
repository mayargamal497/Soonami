...
public class MainActivity extends AppCompatActivity {
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                urlConnection = (HttpURLConnection) url.openConnection();// setting http request
                urlConnection.setRequestMethod("GET");
                urlConnection.setReadTimeout(10000 /* milliseconds */);
                urlConnection.setConnectTimeout(15000 /* milliseconds */);
                urlConnection.connect(); // establish http connection with the server

                if(urlConnection.getResponseCode()==200){//successful
                    inputStream = urlConnection.getInputStream();// receiving the response
        ...
        private Event extractFeatureFromJson(String earthquakeJSON) {
            //empty string or no,, handling empty string case
